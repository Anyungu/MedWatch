...
import {registeringUser} from '../actions';
...
class registerPage extends Component {
    ...
    onRegisterPress () {
        ...
        this.props.registeringUser({email, password,confirm});
...
const mapStateToProps = ({ registerAction }) => {
    ...
    const {name, email, password, confirm, loading, error} =  registerAction;

    return {name, email, password,confirm, loading, error};

};

export default connect(null, {registeringUser})(registerPage);
